...
import {
  ...
  useFocusGuards,
  useId
} from "./chunk-KBYS7NVU.js";
import {
  Primitive,
  composeRefs,
  dispatchDiscreteCustomEvent,
  useComposedRefs
} from "./chunk-73G3TNBM.js";
import {
  createContextScope,
  useCallbackRef,
  useLayoutEffect2
...
var Slot2 = React16.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime13.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React16.isValidElement(newElement) ? React16.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime13.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
Slot2.displayName = "Slot";
var SlotClone2 = React16.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable2(child) {
  return React16.isValidElement(child) && child.type === Slottable2;
}
